package ru.otus.homework.homework27.assertions;

public class Assertions {
    public static void assertEquals(int minExpected, int maxExpected, int actual) {
        if ((minExpected > actual) || (maxExpected < actual)) {
            throw new AssertionError(String.format("Expected %d in [%d, %d]", actual, minExpected, maxExpected));
        }
    }
